...
class VMAutomation:
    ...
    def cleanup(self):
        ...
        try:
            ...
            if (
                hasattr(self.vm_navigator, "tools")
                and self.vm_navigator.tools
                and hasattr(self.vm_navigator.tools, "screen_capture")
            ):
                try:
            ...
            if (
                self.app_controller
                and hasattr(self.app_controller, "tools")
                and self.app_controller.tools
                and hasattr(self.app_controller.tools, "screen_capture")
            ):
                try:
