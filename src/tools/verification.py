...
from src.vision.ui_finder import UIFinder, UIElement
...
class VerificationResult:
    ...
    found_elements: Optional[List[UIElement]] = None
...
class ActionVerifier:
    ...
    def verify_click_success(self, before_screenshot: np.ndarray, 
                           after_screenshot: np.ndarray, 
                           expected_change: str = "any") -> VerificationResult:
        """
    ...
    def verify_text_input(self, screenshot: np.ndarray, 
                         input_region: Tuple[int, int, int, int],
                         expected_text: str) -> VerificationResult:
        """
    ...
    def verify_element_present(self, screenshot: np.ndarray, 
                             element_description: str) -> VerificationResult:
        """
    ...
    def verify_page_loaded(self, screenshot: np.ndarray, 
    ...
    def wait_for_element(self, capture_func, element_description: str, 
                        max_attempts: int = 10, delay: float = 1.0) -> VerificationResult:
        """
