...
class RDPConnection(VMConnection):
    ...
    def connect(self, host: str, port: int = 3389, username: str | None = None, password: str | None = None, **kwargs) -> ConnectionResult:
        ...
        try:
            ...
            if not shutil.which("xfreerdp"):
                return ConnectionResult(False, "FreeRDP (xfreerdp) not found. Install with: sudo apt install freerdp2-x11")
