...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "mock: mark test as using mock implementations")
    config.addinivalue_line("markers", "real_vm: mark test as requiring real VM connection")
