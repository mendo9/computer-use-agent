...
class TestRDPConnection:
    ...
    def test_connect_success_with_xvfb(self, mock_sleep, mock_makedirs, mock_exists, mock_which, mock_popen, mock_mkdtemp):
    ...
    @patch('automation.remote.connections.rdp.os.path.exists')
    @patch('automation.remote.connections.rdp.time.sleep')
    def test_connect_freerdp_fails(self, mock_sleep, mock_exists, mock_which, mock_popen, mock_mkdtemp):
    ...
    @patch('automation.remote.connections.rdp.subprocess.run')
    @patch('automation.remote.connections.rdp.shutil.which')
    def test_capture_screen_scrot_success(self, mock_which, mock_subprocess, mock_unlink, mock_exists, mock_imread):
    ...
    @patch('automation.remote.connections.rdp.subprocess.run')
    @patch('automation.remote.connections.rdp.shutil.which')
    def test_capture_with_xwd_convert_success(self, mock_which, mock_subprocess, mock_exists, mock_unlink):
...
class TestRDPConnectionIntegration:
    ...
    @patch('automation.remote.connections.rdp.os.path.exists')
    @patch('automation.remote.connections.rdp.time.sleep')
    def test_full_connection_workflow(self, mock_sleep, mock_exists, mock_which, mock_subprocess_run, mock_popen, mock_mkdtemp):
