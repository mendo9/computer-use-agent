...
class TestFormFiller:
    ...
    def test_find_field_by_label_success(self):
        ...
        with patch('ocr.find_elements_by_text', return_value=[mock_element]):
    ...
    def test_find_field_by_label_multiple_matches(self):
        ...
        with patch('ocr.find_elements_by_text', return_value=mock_elements):
            result = form_filler.find_field_by_label("Username")
    ...
    def test_fill_field_success_with_input_field(self):
        ...
        form_filler.find_field_by_label = Mock(return_value={
            "text": "Username",
            "center": (100, 50),
            "confidence": 0.95
        })
        ...
        form_filler.find_input_field_near = Mock(return_value={
            "center": (150, 50),
            "confidence": 0.8
        })
...
class TestFormFillerErrorHandling:
    ...
    def test_find_field_by_label_exception(self):
        ...
        with patch('automation.local.form_interface.find_elements_by_text', side_effect=Exception("OCR error")):
            result = form_filler.find_field_by_label("Username")
